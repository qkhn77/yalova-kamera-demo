@php
    ...
    $isDashboard = request()->is('admin') || request()->is('admin/');

    $isMuhasebe = str_starts_with($currentPath, 'admin/muhasebe');
    $isFatura = str_starts_with($currentPath, 'admin/muhasebe/fatura');
    $isFinans = str_starts_with($currentPath, 'admin/muhasebe/finans');
    $isSatis = str_starts_with($currentPath, 'admin/muhasebe/satis');

    $isTeknikServis = str_starts_with($currentPath, 'admin/teknik-servis');
    $isCihazKayit = str_starts_with($currentPath, 'admin/teknik-servis/cihaz-kayit');
    $isServisKayit = str_starts_with($currentPath, 'admin/teknik-servis/servis-kayit');
    $isTeknikAyarlar = str_starts_with($currentPath, 'admin/teknik-servis/ayarlar');

    $isWeb = str_starts_with($currentPath, 'admin/web');
    $isSayfalar = str_starts_with($currentPath, 'admin/web/sayfalar');
    $isServisler = str_starts_with($currentPath, 'admin/web/servisler');
    $isProjeler = str_starts_with($currentPath, 'admin/web/projeler');
    $isBloglar = str_starts_with($currentPath, 'admin/web/bloglar');
    $isWebAyarlar = str_starts_with($currentPath, 'admin/web/web-ayarlar');

    $isAyarlar = str_starts_with($currentPath, 'admin/ayarlar');
    $isKullaniciAyarlari = str_starts_with($currentPath, 'admin/ayarlar/kullanici-ayarlari');
@endphp
...
>
    ...
    <nav class="flex flex-col gap-0.5" aria-label="Ana menü">
        ...
        <div x-show="muhasebeOpen" x-collapse class="nav-group">
            <a href="{{ Cari::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/cari') ? 'is-active' : '' }}"><span>Cari</span></a>
            <a href="{{ Stok::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/stok') ? 'is-active' : '' }}"><span>Stok</span></a>
            ...
            <div x-show="faturaOpen" x-collapse class="nav-group">
                <a href="{{ GelenFatura::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/fatura/gelen-fatura') ? 'is-active' : '' }}"><span>Gelen Fatura</span></a>
                <a href="{{ GidenFatura::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/fatura/giden-fatura') ? 'is-active' : '' }}"><span>Giden Fatura</span></a>
                <a href="{{ BekleyenFatura::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/fatura/bekleyen-fatura') ? 'is-active' : '' }}"><span>Bekleyen Fatura</span></a>
                <a href="{{ IptalFatura::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/fatura/iptal-fatura') ? 'is-active' : '' }}"><span>İptal Fatura</span></a>
            </div>
            ...
            <div x-show="finansOpen" x-collapse class="nav-group">
                <a href="{{ Kasalar::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/finans/kasalar') ? 'is-active' : '' }}"><span>Kasalar</span></a>
                <a href="{{ Bankalar::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/finans/bankalar') ? 'is-active' : '' }}"><span>Bankalar</span></a>
            </div>
            ...
            <div x-show="satisOpen" x-collapse class="nav-group">
                <a href="{{ KasaSatis::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/satis/kasa-satis') ? 'is-active' : '' }}"><span>Kasa Satış</span></a>
                <a href="{{ PosSatis::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/satis/pos-satis') ? 'is-active' : '' }}"><span>Pos Satış</span></a>
                <a href="{{ BankaSatis::getUrl() }}" class="nav-item {{ request()->is('admin/muhasebe/satis/banka-satis') ? 'is-active' : '' }}"><span>Banka Satış</span></a>
            </div>
        </div>
        ...
        <div x-show="teknikServisOpen" x-collapse class="nav-group">
            <a href="{{ ServisDashboard::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/servis-dashboard') ? 'is-active' : '' }}"><span>Servis Dashboard</span></a>
            ...
            <div x-show="cihazKayitOpen" x-collapse class="nav-group">
                <a href="{{ CihazEkle::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/cihaz-kayit/cihaz-ekle') ? 'is-active' : '' }}"><span>Cihaz Ekle</span></a>
                <a href="{{ ArizaliCihazlar::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/cihaz-kayit/arizali-cihazlar') ? 'is-active' : '' }}"><span>Arızalı Cihaz Listesi</span></a>
                <a href="{{ TeslimEdilenCihazlar::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/cihaz-kayit/teslim-edilen-cihazlar') ? 'is-active' : '' }}"><span>Teslim Edilen Cihazlar</span></a>
            </div>
            ...
            <div x-show="servisKayitOpen" x-collapse class="nav-group">
                <a href="{{ ServisEkle::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/servis-kayit/servis-ekle') ? 'is-active' : '' }}"><span>Servis Ekle</span></a>
                <a href="{{ ServisListesi::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/servis-kayit/servis-listesi') ? 'is-active' : '' }}"><span>Servis Listesi</span></a>
                <a href="{{ TamamlananServisler::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/servis-kayit/tamamlanan-servisler') ? 'is-active' : '' }}"><span>Tamamlanan Servisler</span></a>
            </div>
            ...
            <div x-show="teknikAyarlarOpen" x-collapse class="nav-group">
                <a href="{{ CihazMarkaModelEkleme::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/cihaz-marka-model-ekleme') ? 'is-active' : '' }}"><span>Cihaz / Marka / Model</span></a>
                <a href="{{ AksesuarEkleme::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/aksesuar-ekleme') ? 'is-active' : '' }}"><span>Aksesuar Ekleme</span></a>
                <a href="{{ ArizaEkleme::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/ariza-ekleme') ? 'is-active' : '' }}"><span>Arıza Ekleme</span></a>
                <a href="{{ KabulFisi::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/kabul-fisi') ? 'is-active' : '' }}"><span>Kabul Fişi</span></a>
                <a href="{{ TeslimFisi::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/teslim-fisi') ? 'is-active' : '' }}"><span>Teslim Fişi</span></a>
                <a href="{{ GenelAyarlar::getUrl() }}" class="nav-item {{ request()->is('admin/teknik-servis/ayarlar/genel-ayarlar') ? 'is-active' : '' }}"><span>Genel Ayarlar</span></a>
            </div>
        </div>
        ...
        <div x-show="webOpen" x-collapse class="nav-group">
            ...
            <div x-show="sayfalarOpen" x-collapse class="nav-group">
                <a href="{{ BilgiSayfalari::getUrl() }}" class="nav-item {{ request()->is('admin/web/sayfalar/bilgi-sayfalari') ? 'is-active' : '' }}"><span>Bilgi Sayfaları</span></a>
                <a href="{{ Iletisim::getUrl() }}" class="nav-item {{ request()->is('admin/web/sayfalar/iletisim') ? 'is-active' : '' }}"><span>İletişim</span></a>
                <a href="{{ Hakkimizda::getUrl() }}" class="nav-item {{ request()->is('admin/web/sayfalar/hakkimizda') ? 'is-active' : '' }}"><span>Hakkımızda</span></a>
            </div>
            <a href="{{ WebModuller::getUrl() }}" class="nav-item {{ request()->is('admin/web/web-moduller') ? 'is-active' : '' }}"><span>Modüller</span></a>
            ...
            <div x-show="servislerOpen" x-collapse class="nav-group">
                <a href="{{ WebServisListesi::getUrl() }}" class="nav-item {{ request()->is('admin/web/servisler/web-servis-listesi') ? 'is-active' : '' }}"><span>Servis Listesi</span></a>
                <a href="{{ WebServisKategori::getUrl() }}" class="nav-item {{ request()->is('admin/web/servisler/web-servis-kategori') ? 'is-active' : '' }}"><span>Servis Kategori</span></a>
            </div>
            ...
            <div x-show="projelerOpen" x-collapse class="nav-group">
                <a href="{{ WebProje::getUrl() }}" class="nav-item {{ request()->is('admin/web/projeler/web-proje') ? 'is-active' : '' }}"><span>Projeler</span></a>
                <a href="{{ WebProjeKategori::getUrl() }}" class="nav-item {{ request()->is('admin/web/projeler/web-proje-kategori') ? 'is-active' : '' }}"><span>Proje Kategorileri</span></a>
            </div>
            ...
            <div x-show="bloglarOpen" x-collapse class="nav-group">
                <a href="{{ BlogListesi::getUrl() }}" class="nav-item {{ request()->is('admin/web/blog-listesi') ? 'is-active' : '' }}"><span>Blog Listesi</span></a>
                <a href="{{ BlogKategori::getUrl() }}" class="nav-item {{ request()->is('admin/web/blog-kategori') ? 'is-active' : '' }}"><span>Blog Kategorileri</span></a>
            </div>
            ...
            <div x-show="webAyarlarOpen" x-collapse class="nav-group">
                <a href="{{ WebGenelAyarlar::getUrl() }}" class="nav-item {{ request()->is('admin/web/web-ayarlar/web-genel-ayarlar') ? 'is-active' : '' }}"><span>Genel Ayarlar</span></a>
                <a href="{{ WebApiAyarlar::getUrl() }}" class="nav-item {{ request()->is('admin/web/web-ayarlar/web-api-ayarlar') ? 'is-active' : '' }}"><span>Api Ayarları</span></a>
                <a href="{{ WebMailAyarlar::getUrl() }}" class="nav-item {{ request()->is('admin/web/web-ayarlar/web-mail-ayarlar') ? 'is-active' : '' }}"><span>Mail Ayarları</span></a>
            </div>
        </div>
        ...
        <div x-show="ayarlarOpen" x-collapse class="nav-group">
            ...
            <div x-show="kullaniciAyarlariOpen" x-collapse class="nav-group">
                <a href="{{ Kullanicilar::getUrl() }}" class="nav-item {{ request()->is('admin/ayarlar/kullanici-ayarlari/kullanicilar') ? 'is-active' : '' }}"><span>Kullanıcılar</span></a>
                <a href="{{ KullaniciGruplari::getUrl() }}" class="nav-item {{ request()->is('admin/ayarlar/kullanici-ayarlari/kullanici-gruplari') ? 'is-active' : '' }}"><span>Kullanıcı Grupları</span></a>
            </div>
        </div>
    </nav>
</div>
