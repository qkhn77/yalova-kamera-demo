...
class AyarlarMail extends Page
{
    ...
    public function mount(): void
    {
        $this->form->fill([
            ...
            'mail_password' => '', // Güvenlik: şifre sayfada gösterilmez; değiştirmek için yazılır
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('SMTP Bağlantısı')
                    ->description('E-posta gönderimi için SMTP sunucu bilgileri. Laravel mail yapılandırması bu değerlerle güncellenir.')
    ...
    public function save(): void
    {
        ...
        // Şifre boşsa mevcut değeri koru (form boş döndürür)
